  ...
  return (
    <div className="App">
      ...
      <nav className="navBar">
        ...
        <Link to="/randomGifs" className="navLink">Random GIFs</Link>
        <Link to="/trendingGifs" className="navLink">Trending GIFs</Link>
        <Link to="/searchGifs" className="navLink">Search GIFs</Link>
        <Link to="/randomStickers" className="navLink">Random Stickers</Link>
        <Link to="/trendingStickers" className="navLink">Trending Stickers</Link>
        <Link to="/searchStickers" className="navLink">Search Stickers</Link>
        <Link to="/autocomplete" className="navLink">Autocomplete</Link>
        <Link to="/translate" className="navLink">Translate</Link>
        <Link to="/previousSearches" className="navLink">Previous Searches</Link>
      </nav>
      <Outlet />
    </div>
  )
...
//   if (!input) {
//     setResults(getRandomGif().data)
//   } else {
//     const data = getGif(input).data
//     setResults(data)
//     setHistory(input)

//     const saveResult = data.map(({ id, url, images: { original_mp4: { mp4 } } }) => 
